...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_player_race ON view_player_race_matrix (player);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_top30_bat ON view_top_30_batting_race (match_seq, player);
